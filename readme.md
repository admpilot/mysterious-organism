...
##PREREQUISITES
###1.
###2. The functions returnRandBase and mockUpStrand are provided by codecademy along with some context about the 4 types of bases that comprise DNA (**A**denine, **T**hymine, **C**ytosine, and **G**uanine). returnRandBase generates 1 of the 4 bases, while mockUpStrand generates an array representing a DNA strand containing 15 bases to simulate a mysterious organism.
